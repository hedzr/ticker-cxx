...
namespace ticker::traits {
  ...
  /**
     ...
     * @details For example:
     * @code{c++}
     *     auto fn = ticker::traits::lambda([&](std::vector<std::string> const &vec){...});
     *     fn(vec);
     * @endcode
     */
  template<class L>
...
namespace ticker::traits {
  ...
  /**
     ...
     * @detail For example:
     * @code{c++}
     *   ticker::traits::drop_from_end&lt;3, const char*, double, int, int&gt;::type b{"pi"};
     *   std::cout &lt;&lt; b &lt;&lt; '\n';
     *
     *   ticker::traits::drop_from_end&lt;2, const char*, double, int, int&gt;::type c{"pi", 3.1415};
...
namespace ticker::util {
  ...
  /**
     ...
     *   };
     *   
     *   auto fn0 = ticker::traits::bind([](int a, float b) {
     *     std::cout &lt;&lt; a &lt;&lt; ',' &lt;&lt; b &lt;&lt; '\n';
     *   }, _1, _2);
     *   fn0(1, 20.f);
     *
     *   moo m;
     *   auto fn1 = ticker::traits::bind(&moo::doit, m, _1, 3.0f);
     *   std::cout &lt;&lt; '\n' &lt;&lt; fn1(1);
     *   
     *   auto fn2 = ticker::traits::bind(doit, _1, 3.0f);
     *   std::cout &lt;&lt; '\n' &lt;&lt; fn2(9);
     * @endcode
     */
...
#define TICKER_SINGLETON(t) ticker::util::singleton<t>
...
namespace ticker::util {
  ...
  /**
     ...
     *     ticker::util::defer ofs_closer(ofs);
     *     ticker::util::defer ofs_closer(ofs, []{ return; });
     *     
     *     // with a lambda
     *     ticker::util::defer&lt;bool&gt; fn_closer([]{
     *         // ... your closer here
     *     });
     * @endcode
  ...
  /**
     ...
     * @details For example:
     * @code{c++}
     *     ticker::util::defer&lt;bool&gtl fn_closer([]{
     *         // ... your closer here
     *     });
     * @endcode
     */
