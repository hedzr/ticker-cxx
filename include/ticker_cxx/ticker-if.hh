...
#ifndef TICKER_CXX_TICKER_IF_HH
#define TICKER_CXX_TICKER_IF_HH
...
namespace ticker::traits {
     ...
     * @details For example:
     * @code{c++}
     * static_assert(ticker::traits::has_begin&lt;std::string>::value);
     * 
     * void test_begin() {
     *     if constexpr (ticker::traits::has_begin_v&lt;Container>) {
