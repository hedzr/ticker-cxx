...
#ifndef TICKER_CXX_TICKER_DEF_HH
#define TICKER_CXX_TICKER_DEF_HH
...
#define TICKER_ASSERT(...) assert(__VA_ARGS__)
#else
...
#if defined(TICKER_CXX_ENABLE_ASSERTIONS)
...
#if defined(__GNUC__)
#define TICKER_EXPORT __attribute__((__visibility__("default")))
#else
#define TICKER_EXPORT
#endif
#if defined(__has_feature)
#define TICKER_HAS_FEATURE(...) __has_feature(__VA_ARGS__)
#else
#define TICKER_HAS_FEATURE(...) 0
#endif
#if TICKER_HAS_FEATURE(thread_sanitizer) || __SANITIZE_THREAD__
#ifndef TICKER_SANITIZE_THREAD
#define TICKER_SANITIZE_THREAD 1
#endif
#endif
...
// }
//
// template<class T, class = decltype(ticker::detail::check<T>())>
